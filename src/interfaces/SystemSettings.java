...
public class SystemSettings {
    ...
    public static final Map<Class, Integer[]> TYPE_PAYMENTS = Map.of(ITypePayments.class, new Integer[]{-1,1},
    ...
    public static final ITypePayments[] DEFAULT_TYPESPAYMENTS = new ITypePayments[] {
